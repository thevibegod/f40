  ...
  return(
        <div className="container">
          <ul style={listStyles}>
            ...
            <li style={listItemStyles}><Link to={`/Profile&${this.props.username}`}>My Profile</Link></li>
            <li style={listItemStyles}><Link to={`/MenteeProfile&${this.props.username}`}>Mentee Profiles</Link></li>
